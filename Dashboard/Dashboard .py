...
def fig_bev_wanderung(vals):
    raw_data = pd.read_csv(
        'https://raw.githubusercontent.com/peterjthul/DataAnalyst_Project/main/wanderungen-deutschland-ausland-monate.csv',
...
def bev_homoehen_fig():
    # Daten einlesen
    data = pd.read_csv(
        'https://raw.githubusercontent.com/peterjthul/DataAnalyst_Project/main/gleichgeschlechtliche-eheschliessungen.csv',
...
def bev_ehen_fig():
    # Daten einlesen
    data = pd.read_csv('https://raw.githubusercontent.com/peterjthul/DataAnalyst_Project/main/12611-0001.csv',
...
def dashboard():
    ...
    df_treib_I90 = pd.read_csv(
        'https://raw.githubusercontent.com/peterjthul/DataAnalyst_Project/main/treibhausgase_I90.csv')
    ...
    data_road = pd.read_csv(
        'https://raw.githubusercontent.com/peterjthul/DataAnalyst_Project/main/46131-0003_Gueterverkehr_Strasse_bearbeitete_daten.csv')
    data_rail = pd.read_csv(
        'https://raw.githubusercontent.com/peterjthul/DataAnalyst_Project/main/46131-0003_Gueterverkehr_Eisenbahn_bearbeitete_daten.csv')
    data_BIP = pd.read_csv(
        'https://raw.githubusercontent.com/peterjthul/DataAnalyst_Project/main/81000-0001_BWS,BIP_bearbeitete_daten.csv')
    merge_BIP_road = pd.read_csv(
        'https://raw.githubusercontent.com/peterjthul/DataAnalyst_Project/main/BIP_Strasse_merge.csv')
    merge_BIP_rail = pd.read_csv(
        'https://raw.githubusercontent.com/peterjthul/DataAnalyst_Project/main/BIP_Eisenbahn_merge.csv')
    merge_BIP_road_rail = pd.read_csv(
        'https://raw.githubusercontent.com/peterjthul/DataAnalyst_Project/main/BIP_Strasse_Eisenbahn_merge.csv')
